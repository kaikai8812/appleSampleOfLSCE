...
struct NextTrailManeuver: AppIntent {
    ...
    static var title: LocalizedStringResource = "Get Next Navigation Step"
    static var description = IntentDescription("Provides the next step during navigation, such as when to take an upcoming turn.")
    
    /// Hide this intent from the Shortcuts app, since its use targets the Action button.
